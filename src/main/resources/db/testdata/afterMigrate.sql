...
insert into book (id, title, isbn, author_id, stock_id) values (1, 'A bela e a fera', '9788526502758', 1, 1);

insert into author(id, name, nationality) values (2, 'Maquiavel', 'Françes');
insert into stock(id, quantity, active) values (2, 100, 0);
insert into book (id, title, isbn) values (2, 'O Príncipe', '6502758701664');
